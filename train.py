...
while epoch < n_epochs:
  ...
  if epoch < n_epochs: # don't evaluate if cost was NAN
    ...
    time1Eval = time.time()
    curF1 = evaluateModel(data_stream_dev, epoch, doCRF, numClasses, numClassesET, getPredictions, getPredictionsR1, getPredictionsET1, getPredictionsET2)
    time2Eval = time.time()
...
f1_test = evaluateModel(data_stream_test, best_epoch, doCRF, numClasses, numClassesET, getPredictions, getPredictionsR1, getPredictionsET1, getPredictionsET2)
